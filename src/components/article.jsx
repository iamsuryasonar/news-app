...
function Article({ article, index, arr }) {
    return <div className='relative w-full h-svh bg-green-200 text-white'>
        ...
        <div className='absolute bottom-6 left-4 right-4 bg-black bg-opacity-[10%] backdrop-blur-sm flex flex-row justify-between items-center p-3 rounded-lg'>
            <div className='flex flex-col gap-1'>
